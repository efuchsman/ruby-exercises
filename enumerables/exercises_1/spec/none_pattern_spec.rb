RSpec.describe 'none pattern' do
  ...
  it 'none shall pass' do
    ...
    critters.each {|critter| none_shall_pass = false if critter.include?("shall pass")}
  ...
  it 'one or more shall pass' do
    ...
    none_shall_pass = true
    phrases.each {|phrase| none_shall_pass = false if phrase.split.count > 1}
  ...
  it 'none even' do
    ...
    none_even = true
    numbers.each {|number| none_even = false if number.even?}
