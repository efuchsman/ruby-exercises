RSpec.describe 'reject pattern' do
  ...
  it 'removes vowels' do
    ...
    letters.each do |letter|
      remaining << letter unless letter == "a" || letter== "e" ||letter == "i" || letter== "o" ||letter=="u" || letter == "y"
    end
  ...
  it 'removes words ending in e' do
    ...
    selected =[]
    words.each do |word|
      selected << word unless word.chars.last == "e"
    end
  ...
  it 'removes words ending in ing' do
    ...
    selected = []
    words.each do |word|
      selected << word if word.chars.last(3) != ["i", "n", 'g']
    end
  ...
  it 'removes numbers' do
    ...
    elements.each do |element|
      not_numbers << element unless element == element.to_i || element == element.to_f
    end
